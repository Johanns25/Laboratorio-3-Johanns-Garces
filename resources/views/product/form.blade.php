<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="descripçion" class="form-label">{{ __('Descripçion') }}</label>
            <input type="text" name="descripçion" class="form-control @error('descripçion') is-invalid @enderror" value="{{ old('descripçion', $product?->descripçion) }}" id="descripçion" placeholder="Descripçion">
            {!! $errors->first('descripçion', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
